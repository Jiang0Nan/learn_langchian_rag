...
from lear_langchain.ragflow.api.constants import IMG_BASE64_PREFIX, FILE_NAME_LEN_LIMIT
from lear_langchain.ragflow.api.db import FileType, LLMType, ParserType, StatusEnum, TaskStatus, UserTenantRole
from lear_langchain.ragflow.api.db.db_models import DB, Document, Knowledgebase, Task, Tenant, UserTenant, File2Document, File
from lear_langchain.ragflow.api.db.db_utils import bulk_insert_into_db
from lear_langchain.ragflow.api.db.services.common_service import CommonService
from lear_langchain.ragflow.api.db.services.knowledgebase_service import KnowledgebaseService
from lear_langchain.ragflow.api.utils import current_timestamp, get_format_time, get_uuid
from lear_langchain.ragflow.rag.nlp import rag_tokenizer, search
from lear_langchain.ragflow.rag.settings import get_svr_queue_name, SVR_CONSUMER_GROUP_NAME
from lear_langchain.ragflow.rag.utils.redis_conn import REDIS_CONN
from lear_langchain.ragflow.rag.utils.storage_factory import STORAGE_IMPL
from lear_langchain.ragflow.rag.utils.doc_store_conn import OrderByExpr
...
class DocumentService(CommonService):
    ...
    def remove_document(cls, doc, tenant_id):
        from lear_langchain.ragflow.api.db.services.task_service import TaskService
    ...
    def accessible(cls, doc_id, user_id):
        docs = cls.model.select(
            ...
            Knowledgebase, on=(
               ...
               ).where(cls.model.id == doc_id, UserTenant.user_id == user_id).paginate(0, 1)#只取一条数据
        docs = docs.dicts()
        if not docs:
            return False
        return True
...
def doc_upload_and_parse(conversation_id, file_objs, user_id):
    from lear_langchain.ragflow.api.db.services.api_service import API4ConversationService
    from lear_langchain.ragflow.api.db.services.conversation_service import ConversationService
    from lear_langchain.ragflow.api.db.services.dialog_service import DialogService
    from lear_langchain.ragflow.api.db.services.file_service import FileService
    from lear_langchain.ragflow.api.db.services.llm_service import LLMBundle
    from lear_langchain.ragflow.api.db.services.user_service import TenantService
    from lear_langchain.ragflow.rag.app import audio, email, naive, picture, presentation

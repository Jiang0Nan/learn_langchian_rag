...
from lear_langchain.ragflow.api.db import LLMType, ParserType, StatusEnum
from lear_langchain.ragflow.api.db.db_models import DB, Dialog
...
from lear_langchain.ragflow.api.db.services.langfuse_service import TenantLangfuseService
from lear_langchain.ragflow.api.db.services.llm_service import LLMBundle
from lear_langchain.ragflow.api.db.services.tenant_llm_service import TenantLLMService
from lear_langchain.ragflow.api.utils import current_timestamp, datetime_format
from lear_langchain.ragflow.rag.app.resume import forbidden_select_fields4resume
from lear_langchain.ragflow.rag.app.tag import label_question
from lear_langchain.ragflow.rag.nlp.search import index_name
from lear_langchain.ragflow.rag.prompts import chunks_format, citation_prompt, cross_languages, full_question, kb_prompt, keyword_extraction, message_fit_in
from lear_langchain.ragflow.rag.prompts.prompts import gen_meta_filter
from lear_langchain.ragflow.rag.utils import num_tokens_from_string, rmSpace
from lear_langchain.ragflow.rag.utils.tavily_conn import Tavily
...
class DialogService(CommonService):
    ...
    def get_by_tenant_ids(cls, joined_tenant_ids, user_id, page_number, items_per_page, orderby, desc, keywords, parser_id=None):
        from lear_langchain.ragflow.api.db.db_models import User

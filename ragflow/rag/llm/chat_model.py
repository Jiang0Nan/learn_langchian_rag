...
from lear_langchain.ragflow.rag.llm import FACTORY_DEFAULT_BASE_URL, LITELLM_PROVIDER_PREFIX, SupportedLiteLLMProvider
from lear_langchain.ragflow.rag.nlp import is_chinese, is_english
...
class LocalLLM(Base):
    ...
    def _prepare_prompt(self, system, history, gen_conf):
        from lear_langchain.ragflow.rag.svr.jina_server import Prompt
    ...
    def _stream_response(self, endpoint, prompt):
        from lear_langchain.ragflow.rag.svr.jina_server import Generation

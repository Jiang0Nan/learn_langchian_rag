...
if __name__ == '__main__':
    # args
    # __dir__ = os.path.dirname(r"D:\projects\learn_langchain_rag\langchain\2.消息，模板，chatModel\file\drug description\枸橼酸氯米芬胶囊.pdf")
    __dir__ = os.path.dirname(r"D:\projects\learn_langchain_rag\langchain\2.消息，模板，chatModel\file\image\枸橼酸氯米芬胶囊_1.png")
    # pdf_files_dir = os.path.join(__dir__, "pdfs")
    pdf_files_dir = os.path.join(__dir__)
